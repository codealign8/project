...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="h-screen flex flex-col justify-center items-center text-center bg-gray-900 text-white p-10">
      ...
      {/* Blog Section */}
      <section id="blog" className="min-h-screen p-10 bg-gray-800 text-white">
        <h2 className="text-5xl font-bold text-center mb-10 border-b-4 border-blue-500 pb-4">Blog & Research</h2>

        <h3 className="text-3xl font-semibold text-blue-400 mb-6">Featured Blogs</h3>
        <div className="flex justify-center">
          <Link href="https://community.analyticsvidhya.com/u/8c599efa" target="_blank" className="px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition">
            Read My Blogs
          </Link>
        </div>

        <h3 className="text-3xl font-semibold text-yellow-400 mt-12 mb-6">Kaggle Contributions</h3>
        <div className="flex justify-center">
          <Link href="https://www.kaggle.com/jhonmac98" target="_blank" className="px-6 py-3 bg-yellow-500 text-black rounded-lg hover:bg-yellow-600 transition">
      ...
      {/* Contact Section */}
      <section id="contact" className="min-h-screen flex flex-col items-center justify-center bg-gray-900 text-white p-10 text-center">
